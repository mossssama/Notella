package com.example.notes.sharedPrefs;
...
public class SINGLETON_SharedPrefToSearch{
    private static SharedPreferences sharedPrefs =null;
    private static final String NAME="ToSearch";                      /*xml file name*/
    private static SharedPreferences.Editor prefsEditor;

    private SINGLETON_SharedPrefToSearch(){}
